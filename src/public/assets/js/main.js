...
$(window).scroll(() => {
  ...
  const elemRect = header.getBoundingClientRect();
...
function stickify(something) {
  ...
  if (document.getElementsByClassName("dd-content")[0]) {
    document.getElementsByClassName("dd-content")[0].style.boxShadow =
      "0px 4px 4px -4px rgb(136, 136, 136), -4px 0 4px -4px rgb(136, 136, 136)";
  }
}
...
$(document).ready(() => {
  ...
  const w = login.getBoundingClientRect().width;
